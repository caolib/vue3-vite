...
<template>
  ...
  <!--用户登录表单-->
  <el-form ref="ruleFormRef" status-icon label-width="120px" class="centered-form"
           :model="loginDto" :rules="rules" title="登录">
    <!--用户名-->
    ...
    <el-form-item label="密码" prop="password" class="form-row" required>
      <el-input v-model.number="loginDto.password" type="password" show-password/>
    </el-form-item>
